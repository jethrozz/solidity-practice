...
contract MySwap is ERC20{
    ...
    //构造函数初始化代币地址
    constructor(MY_WETH _myWeth, IERC20 _token1) ERC20("MY_SWAP", "MYCSMM"){
        myWeth = _myWeth;
        token1 = _token1;
    }
    ...
    // @param amount0Desired 添加的myWeth数量
    ...
    function addLiquidity(uint amount0Desired, uint amount1Desired) public returns(uint liquidity){
        ...
        myWeth.transferFrom(msg.sender, address(this), amount0Desired);
        ...
        // 更新储备量
        reserve0 = myWeth.balanceOf(address(this));
    ...
    function removeLiquidity(uint liquidity) external returns (uint amount0, uint amount1) {
        // 获取余额
        uint balance0 = myWeth.balanceOf(address(this));
        ...
        // 转出代币
        myWeth.transfer(msg.sender, amount0);
    ...
    function swap(uint amountIn, IERC20 tokenIn, uint amountOutMin) external returns (uint amountOut, IERC20 tokenOut){
        ...
        require(tokenIn == myWeth || tokenIn == token1, 'INVALID_TOKEN');
